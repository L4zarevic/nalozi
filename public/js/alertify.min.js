...
function checkFormDecision(e) {

    const int_num = document.getElementById("int_num").value;
    const date1 = document.getElementById("date1").value;
    const select_employees = document.getElementById("select_employees").value;
    const date2 = document.getElementById("date2").value;
    const relations = document.getElementById("relations").value;
    const reasons = document.getElementById("reasons").value;
    const select_vehicle = document.getElementById("select_vehicle").value;

    if (int_num.length == 0) {
        document.getElementById("int_num").focus();
        alertify.alert('Informacija', "Niste unijeli interni broj");
        return false;
    }
    ...
    if (select_employees == 0) {
        document.getElementById("select_employees").focus();
        alertify.alert('Informacija', "Niste izabrali ime radnika");
        return false;
    }
    ...
    if (relations.length == 0) {
        document.getElementById("relations").focus();
        alertify.alert('Informacija', "Niste unijeli relaciju");
        return false;
    }
	    
	if (reasons.length == 0) {
        document.getElementById("reasons").focus();
        alertify.alert('Informacija', "Niste unijeli razlog putovanja");
        return false;
    }

    if (select_vehicle == 0) {
        document.getElementById("select_vehicle").focus();
        alertify.alert('Informacija', "Niste izabrali vozilo");
        return false;
    }

    var answer = window.confirm("Da li želite da kreirate odluku?");
...
function checkFormReport(e) {

    const date_departure = document.getElementById("date-departure").value;
    const select_employees = document.getElementById("select-employees-rp").value;
    const date_arrival = document.getElementById("date-arrival").value;
    const reasons = document.getElementById("reasons").value;
    const select_vehicle = document.getElementById("select-vehicle-rp").value;

    if (date_departure.length == 0) {
        document.getElementById("date-departure").focus();
        alertify.alert('Informacija', "Niste unijeli datum odlaska");
        return false;
    }

    if (date_arrival.length == 0) {
        document.getElementById("date-arrival").focus();
        alertify.alert('Informacija', "Niste unijeli datum dolaska");
        return false;
    }

    if (select_employees == 0) {
        document.getElementById("select-employees-rp").focus();
        alertify.alert('Informacija', "Niste izabrali ime radnika");
        return false;
    }

    if (select_vehicle == 0) {
        document.getElementById("select-vehicle-rp").focus();
        alertify.alert('Informacija', "Niste izabrali vozilo");
        return false;
    }
	...
	if (reasons.length == 0) {
        document.getElementById("reasons").focus();
        alertify.alert('Informacija', "Niste unijeli izvještaj sa putovanja");
        return false;
    }
	
	var answer = window.confirm("Da li želite da kreirate izvještaj?");
...
function checkFormEmployees(e){
	
	const employeesName = document.getElementById("add-employees").value;
	 
	if (employeesName.length == 0) {
        document.getElementById("add-employees").focus();
        alertify.alert('Informacija', "Niste unijeli ime i prezime zaposlenog");
        return false;
    }
	
	var answer = window.confirm("Da li želite da dodate zaposlenog?");
...
function checkFormVehicle(e){
	const vehicleCar = document.getElementById("add-vehicle-car").value;
	const vehicleRegistration = document.getElementById("add-vehicle-registration").value;
	
	if (vehicleCar.length == 0) {
        document.getElementById("add-vehicle-car").focus();
        alertify.alert('Informacija', "Niste unijeli naziv vozila");
        return false;
    }
	
	if (vehicleRegistration.length == 0) {
        document.getElementById("add-vehicle-registration").focus();
        alertify.alert('Informacija', "Niste unijeli registraciju vozila");
        return false;
    }
	
	var answer = window.confirm("Da li želite da dodate vozilo?");
...
function filterResult(){
	const employees = document.getElementById("select_employees").value;
	const vehicle = document.getElementById("select_vehicle").value;
	
	$.ajax({
        url: "/nalozi/decision-history",
        type: "get",
        data: {
			select_employees: employees,
