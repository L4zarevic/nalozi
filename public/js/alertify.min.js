...
function checkFormDecision(e) {
	...
	if(id_decision.length == 0){
		 answer = window.confirm("Da li želite da kreirate odluku?");
	}else{
		 answer = window.confirm("Da li želite da uredite odluku?");
	}
...
function checkFormReport(e) {
	...
	if(id_report.length == 0){
		 answer = window.confirm("Da li želite da kreirate izvještaj?");
	}else{
		 answer = window.confirm("Da li želite da uredite izvještaj?");
	}
